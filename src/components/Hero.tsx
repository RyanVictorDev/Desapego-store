        ...
        <div className="hero-visual">
          <div className="hero-collage">
            <div className="hero-collage-main">
              <ProductImage src={heroImages.main} alt="Peça em destaque" loading="eager" />
              <blockquote className="hero-quote">{STORE_SLOGAN}</blockquote>
            </div>
            <div className="hero-collage-side">
              <div className="hero-collage-small">
                <ProductImage src={heroImages.top} alt="Look casual" loading="eager" />
              </div>
              <div className="hero-collage-small">
                <ProductImage src={heroImages.bottom} alt="Peça selecionada" loading="eager" />
              </div>
            </div>
          </div>
        </div>
